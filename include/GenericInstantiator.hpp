...
namespace Ace
{
    ...
    public:
        ...
        static auto GetGenericRoot(const IGenericSymbol* const instance) -> IGenericSymbol*;

        auto InstantiateBodies(const std::vector<FunctionBlockBinding>& functionBlockBindings)
            -> Diagnosed<void>;
    ...
    private:
        ...
        static auto DeferOrInstantiateBody(IGenericSymbol* const instance) -> void;
        static auto InstantiateBody(IGenericSymbol* const instance) -> void;

        static auto
        SetupRootBodiesAndMonos(const std::vector<FunctionBlockBinding>& functionBlockBindings)
            -> Diagnosed<void>;
