...
namespace Ace::Node::Var::Normal
{
    class Static :
        ...
        public virtual Node::ICloneable<Node::Var::Normal::Static>,
        public virtual Node::IBindable<BoundNode::Var::Normal::Static>
    {
    public:
        Static(
        ...
        auto CloneInScope(
            const std::shared_ptr<Scope>& t_scope
        ) const -> std::shared_ptr<const Node::Var::Normal::Static> final;
