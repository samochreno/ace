...
namespace Ace::BoundNode::Expression
{
    ...
    public:
        ...
        auto GetOrCreateLowered(const BoundNode::Context::Lowering& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::Expression>>> final;
