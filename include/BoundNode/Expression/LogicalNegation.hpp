...
namespace Ace::BoundNode::Expression
{
    ...
    {
    public:
        LogicalNegation(const std::shared_ptr<const BoundNode::Expression::IBase>& t_expression)
        ...
        auto GetOrCreateTypeChecked(const BoundNode::Context::TypeChecking& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::LogicalNegation>>> final;
        ...
        auto GetOrCreateLowered(const BoundNode::Context::Lowering& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::LogicalNegation>>> final;
