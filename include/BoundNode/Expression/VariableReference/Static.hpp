...
namespace Ace::BoundNode::Expression::VariableReference
{
    ...
    public:
        ...
        auto GetOrCreateLowered(const BoundNode::Context::Lowering& t_context) const -> MaybeChanged<std::shared_ptr<const BoundNode::Expression::VariableReference::Static>> final;
