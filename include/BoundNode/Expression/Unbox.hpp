...
{
    class Unbox :
        public std::enable_shared_from_this<BoundNode::Expression::Unbox>,
        public virtual BoundNode::Expression::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expression::Unbox>,
        public virtual BoundNode::ILowerable<BoundNode::Expression::FunctionCall::Static>
    {
    public:
        Unbox(const std::shared_ptr<const BoundNode::Expression::IBase>& t_expression) 
        ...
        auto GetOrCreateTypeChecked(const BoundNode::Context::TypeChecking& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::Unbox>>> final;
