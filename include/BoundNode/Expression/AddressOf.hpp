...
{
    class AddressOf :
        public std::enable_shared_from_this<BoundNode::Expression::AddressOf>,
        public virtual BoundNode::Expression::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expression::AddressOf>,
        public virtual BoundNode::ILowerable<BoundNode::Expression::AddressOf>
    {
    public:
        AddressOf(const std::shared_ptr<const BoundNode::Expression::IBase>& t_expression)
        ...
        auto GetOrCreateTypeChecked(const BoundNode::Context::TypeChecking& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::AddressOf>>> final;
        ...
        auto GetOrCreateLowered(const BoundNode::Context::Lowering& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::AddressOf>>> final;
