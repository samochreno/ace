...
{
    class If :
        public std::enable_shared_from_this<BoundNode::Stmt::If>,
        public virtual BoundNode::Stmt::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Stmt::If, BoundNode::Stmt::Context::TypeChecking>,
    ...
    public:
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Stmt::If>>> final;
    ...
    private:
        ...
        std::vector<std::shared_ptr<const BoundNode::Expr::IBase>> m_Conditions{};
        std::vector<std::shared_ptr<const BoundNode::Stmt::Block>> m_Bodies{};
    };
}
