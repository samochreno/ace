...
namespace Ace::BoundNode::Variable::Normal
{
    ...
    public:
        ...
        auto GetOrCreateLowered(const BoundNode::Context::Lowering& t_context) const -> MaybeChanged<std::shared_ptr<const BoundNode::Variable::Normal::Static>> final;

        auto GetSymbol() const -> Symbol::Variable::Normal::Static* final { return m_Symbol; }
