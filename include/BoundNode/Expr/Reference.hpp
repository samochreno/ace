...
{
    class Reference :
        public std::enable_shared_from_this<BoundNode::Expr::Reference>,
        public virtual BoundNode::Expr::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expr::Reference>,
        public virtual BoundNode::ILowerable<BoundNode::Expr::Reference>
    {
    public:
        Reference(
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::Reference>>> final;
        auto GetOrCreateTypeCheckedExpr(
            const BoundNode::Context::TypeChecking& t_context
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::IBase>>> final;
        auto GetOrCreateLowered(
            const BoundNode::Context::Lowering& t_context
        ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Expr::Reference>> final;
