...
{
    class AddressOf :
        public std::enable_shared_from_this<BoundNode::Expr::AddressOf>,
        public virtual BoundNode::Expr::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expr::AddressOf>,
        public virtual BoundNode::ILowerable<BoundNode::Expr::AddressOf>
    {
    public:
        AddressOf(
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::AddressOf>>> final;
        auto GetOrCreateTypeCheckedExpr(
            const BoundNode::Context::TypeChecking& t_context
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::IBase>>> final;
        auto GetOrCreateLowered(
            const BoundNode::Context::Lowering& t_context
        ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Expr::AddressOf>> final;
