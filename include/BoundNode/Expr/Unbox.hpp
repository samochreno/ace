...
{
    class Unbox :
        public std::enable_shared_from_this<BoundNode::Expr::Unbox>,
        public virtual BoundNode::Expr::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expr::Unbox>,
    ...
    public:
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::Unbox>>> final;
