...
{
    class Or :
        public std::enable_shared_from_this<BoundNode::Expr::Or>,
        public virtual BoundNode::Expr::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expr::Or>,
        public virtual BoundNode::ILowerable<BoundNode::Expr::Or>
    {
    public:
        Or(
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::Or>>> final;
        auto GetOrCreateTypeCheckedExpr(
            const BoundNode::Context::TypeChecking& t_context
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::IBase>>> final;
        auto GetOrCreateLowered(
            const BoundNode::Context::Lowering& t_context
        ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Expr::Or>> final;
