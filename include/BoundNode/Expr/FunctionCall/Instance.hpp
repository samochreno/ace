...
{
    class Instance :
        public std::enable_shared_from_this<BoundNode::Expr::FunctionCall::Instance>,
        public virtual BoundNode::Expr::IBase,
        public virtual BoundNode::ITypeCheckable<BoundNode::Expr::FunctionCall::Instance>,
        public virtual BoundNode::ILowerable<BoundNode::Expr::FunctionCall::Instance>
    {
    public:
        Instance(
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::FunctionCall::Instance>>> final;
        auto GetOrCreateTypeCheckedExpr(
            const BoundNode::Context::TypeChecking& t_context
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::IBase>>> final;
        auto GetOrCreateLowered(
            const BoundNode::Context::Lowering& t_context
        ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Expr::FunctionCall::Instance>> final;
