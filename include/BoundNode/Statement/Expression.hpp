...
namespace Ace::BoundNode::Statement
{
    ...
    public:
        ...
        ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Statement::Expression>>> final;
        ...
        ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Statement::Expression>> final;
