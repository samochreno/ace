...
namespace Ace
{
    class LabelStmtSema : public std::enable_shared_from_this<LabelStmtSema>,
    ...
    {
    public:
        LabelStmtSema(const SrcLocation& srcLocation, LabelSymbol* const symbol);
        ...
        auto CreateTypeChecked(const StmtTypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const LabelStmtSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const LabelStmtSema> final;
