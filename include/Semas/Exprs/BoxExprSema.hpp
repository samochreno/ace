...
namespace Ace
{
    class BoxExprSema : public std::enable_shared_from_this<BoxExprSema>,
                        public virtual IExprSema,
                        public virtual ITypeCheckableSema<BoxExprSema>,
                        public virtual ILowerableSema<StaticCallExprSema>
    {
    public:
        BoxExprSema(const SrcLocation& srcLocation, const std::shared_ptr<const IExprSema>& expr);
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const BoxExprSema>> final;
