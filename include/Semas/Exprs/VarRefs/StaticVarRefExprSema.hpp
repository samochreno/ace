...
namespace Ace
{
    class StaticVarRefExprSema : public std::enable_shared_from_this<StaticVarRefExprSema>,
    ...
    public:
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const StaticVarRefExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const StaticVarRefExprSema> final;
