...
namespace Ace
{
    class AndExprSema : public std::enable_shared_from_this<AndExprSema>,
    ...
    public:
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const AndExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const AndExprSema> final;
