...
namespace Ace
{
    class TypeInfoPtrExprSema : public std::enable_shared_from_this<TypeInfoPtrExprSema>,
    ...
    public:
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const TypeInfoPtrExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const TypeInfoPtrExprSema> final;
