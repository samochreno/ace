...
namespace Ace
{
    class RefExprSema : public std::enable_shared_from_this<RefExprSema>,
                        public virtual IExprSema,
                        public virtual ITypeCheckableSema<RefExprSema>,
                        public virtual ILowerableSema<RefExprSema>
    {
    public:
        RefExprSema(const SrcLocation& srcLocation, const std::shared_ptr<const IExprSema>& expr);
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const RefExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const RefExprSema> final;
