...
namespace Ace
{
    class DerefAsExprSema : public std::enable_shared_from_this<DerefAsExprSema>,
    ...
    public:
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const DerefAsExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const DerefAsExprSema> final;
