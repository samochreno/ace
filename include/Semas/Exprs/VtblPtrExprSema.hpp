...
namespace Ace
{
    class VtblPtrExprSema : public std::enable_shared_from_this<VtblPtrExprSema>,
    ...
    public:
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const VtblPtrExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const VtblPtrExprSema> final;
