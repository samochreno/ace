...
namespace Ace
{
    class DerefExprSema : public std::enable_shared_from_this<DerefExprSema>,
                          public virtual IExprSema,
                          public virtual ITypeCheckableSema<DerefExprSema>,
                          public virtual ILowerableSema<DerefExprSema>
    {
    public:
        DerefExprSema(const SrcLocation& srcLocation, const std::shared_ptr<const IExprSema>& expr);
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const DerefExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const DerefExprSema> final;
