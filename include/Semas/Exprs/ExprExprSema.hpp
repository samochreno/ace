...
namespace Ace
{
    class ExprExprSema : public std::enable_shared_from_this<ExprExprSema>,
                         public virtual IExprSema,
                         public virtual ITypeCheckableSema<ExprExprSema>,
                         public virtual ILowerableSema<ExprExprSema>
    {
    public:
        ExprExprSema(const SrcLocation& srcLocation, const std::shared_ptr<const IExprSema>& expr);
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const ExprExprSema>> final;
        ...
        auto CreateLowered(const LoweringContext& context) const
            -> std::shared_ptr<const ExprExprSema> final;
