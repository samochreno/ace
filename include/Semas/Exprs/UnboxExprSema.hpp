...
namespace Ace
{
    class UnboxExprSema : public std::enable_shared_from_this<UnboxExprSema>,
                          public virtual IExprSema,
                          public virtual ITypeCheckableSema<UnboxExprSema>,
                          public virtual ILowerableSema<StaticCallExprSema>
    {
    public:
        UnboxExprSema(const SrcLocation& srcLocation, const std::shared_ptr<const IExprSema>& expr);
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const UnboxExprSema>> final;
