...
namespace Ace
{
    class LockExprSema : public std::enable_shared_from_this<LockExprSema>,
                         public virtual IExprSema,
                         public virtual ITypeCheckableSema<LockExprSema>,
                         public virtual ILowerableSema<StaticCallExprSema>
    {
    public:
        LockExprSema(const SrcLocation& srcLocation, const std::shared_ptr<const IExprSema>& expr);
        ...
        auto CreateTypeChecked(const TypeCheckingContext& context) const
            -> Diagnosed<std::shared_ptr<const LockExprSema>> final;
