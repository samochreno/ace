...
namespace Ace
{
    class IfStmtBoundNode :
        ...
        public virtual ICloneableWithDiagnosticsBoundNode<IfStmtBoundNode>,
    ...
    public:
        ...
        ) const -> std::shared_ptr<const IfStmtBoundNode> final;
        auto CloneWithDiagnosticsStmt(
            DiagnosticBag diagnostics
        ) const -> std::shared_ptr<const IStmtBoundNode> final;
        auto GetOrCreateTypeChecked(
            const StmtTypeCheckingContext& context
        ) const -> Expected<Cacheable<std::shared_ptr<const IfStmtBoundNode>>> final;
