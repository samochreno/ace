...
namespace Ace::Application
{
    ...
    auto CreateAndBindFunctionBodies(const std::vector<FunctionBlockBinding>& functionBlockBindings)
        -> Diagnosed<void>;
    auto CreateVerifiedFunctionBlock(
        std::shared_ptr<const BlockStmtSema> functionBlock, ITypeSymbol* const functionTypeSymbol
