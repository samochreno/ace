...
namespace Ace
{
    ...
    auto UnboxExprNode::CreateBound() const -> Diagnosed<std::shared_ptr<const UnboxExprBoundNode>>
    {
    ...
    auto UnboxExprNode::CreateBoundExpr() const -> Diagnosed<std::shared_ptr<const IExprBoundNode>>
    {
        return CreateBound();
    }
}
