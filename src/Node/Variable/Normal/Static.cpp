...
namespace Ace::Node::Variable::Normal
{
    ...
    auto Static::CloneInScope(Scope* const t_scope) const -> std::shared_ptr<const Node::Variable::Normal::Static>
    {
        ...
        return std::make_unique<const Node::Variable::Normal::Static>(
            t_scope,
            m_Name,
            m_TypeName,
            clonedAttributes,
