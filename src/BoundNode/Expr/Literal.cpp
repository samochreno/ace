...
namespace Ace::BoundNode::Expr
{
    ...
    ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expr::Literal>>>
    {
        return CreateUnchanged(shared_from_this());
    }

    auto Literal::GetOrCreateTypeCheckedExpr(
        const BoundNode::Context::TypeChecking& t_context
    ...
    ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Expr::Literal>>
    {
        return CreateUnchanged(shared_from_this());
    }

    auto Literal::GetOrCreateLoweredExpr(
        const BoundNode::Context::Lowering& t_context
    ...
    auto Literal::Emit(Emitter& t_emitter) const -> ExprEmitResult
    {
