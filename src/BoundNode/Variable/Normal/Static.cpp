...
namespace Ace::BoundNode::Variable::Normal
{
    ...
    ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Variable::Normal::Static>>>
    {
    ...
    ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Variable::Normal::Static>>
    {
    ...
    auto Static::GetSymbol() const -> Symbol::Variable::Normal::Static*
    {
        return m_Symbol;
    }
}
