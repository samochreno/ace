...
namespace Ace::BoundNode::Var::Normal
{
    ...
    ) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Var::Normal::Static>>>
    {
        ...
        const auto returnValue = std::make_shared<const BoundNode::Var::Normal::Static>(
            m_Symbol,
    ...
    ) const -> MaybeChanged<std::shared_ptr<const BoundNode::Var::Normal::Static>>
    {
    ...
    auto Static::GetSymbol() const -> Symbol::Var::Normal::Static*
    {
        return m_Symbol;
    }
}
