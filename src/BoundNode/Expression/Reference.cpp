...
namespace Ace::BoundNode::Expression
{
    ...
    auto Reference::GetOrCreateTypeChecked(const BoundNode::Context::TypeChecking& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::Reference>>>
    {
        ...
        const auto returnValue = std::make_shared<const BoundNode::Expression::Reference>(mchCheckedExpression.Value);

        return CreateChanged(returnValue);
    }

    auto Reference::GetOrCreateLowered(const BoundNode::Context::Lowering& t_context) const -> Expected<MaybeChanged<std::shared_ptr<const BoundNode::Expression::Reference>>>
    {
        ...
        const auto returnValue = std::make_shared<const BoundNode::Expression::Reference>(mchLoweredExpression.Value);
