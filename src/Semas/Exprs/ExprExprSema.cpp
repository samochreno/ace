...
namespace Ace
{
    ...
    auto ExprExprSema::CreateTypeChecked(const TypeCheckingContext& context) const
        -> Diagnosed<std::shared_ptr<const ExprExprSema>>
    {
        ...
        return Diagnosed{
            std::make_shared<const ExprExprSema>(GetSrcLocation(), checkedExpr),
            std::move(diagnostics),
        };
    }

    auto ExprExprSema::CreateTypeCheckedExpr(const TypeCheckingContext& context) const
        -> Diagnosed<std::shared_ptr<const IExprSema>>
    {
        return CreateTypeChecked(context);
    }

    auto ExprExprSema::CreateLowered(const LoweringContext& context) const
        -> std::shared_ptr<const ExprExprSema>
    {
        ...
        return std::make_shared<const ExprExprSema>(GetSrcLocation(), loweredExpr)
            ->CreateLowered({});
    }

    auto ExprExprSema::CreateLoweredExpr(const LoweringContext& context) const
