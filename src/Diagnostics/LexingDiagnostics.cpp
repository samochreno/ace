...
namespace Ace
{
    auto CreateUnterminatedMultiLineCommentError(const SrcLocation& srcLocation) -> DiagnosticGroup
    {
        ...
        group.Diagnostics.emplace_back(
            DiagnosticSeverity::Error, srcLocation, "unterminated multiline comment"
        );
    ...
    auto CreateUnterminatedStringLiteralError(const SrcLocation& srcLocation) -> DiagnosticGroup
    {
        ...
        group.Diagnostics.emplace_back(
            DiagnosticSeverity::Error, srcLocation, "unterminated string literal"
        );
    ...
    auto CreateUnexpectedCharacterError(const SrcLocation& srcLocation) -> DiagnosticGroup
    {
        ...
        group.Diagnostics.emplace_back(
            DiagnosticSeverity::Error, srcLocation, "unexpected character"
        );
        ...
        -> DiagnosticGroup
    {
        ...
        group.Diagnostics.emplace_back(
            DiagnosticSeverity::Error, srcLocation, "unknown numeric literal type suffix"
        );
        ...
        -> DiagnosticGroup
    {
        ...
        group.Diagnostics.emplace_back(
            DiagnosticSeverity::Error, srcLocation, "decimal point in non-float numeric literal"
        );
