...
namespace Ace
{
    ...
    auto CompoundAssignmentStmtSyntax::CreateSema() const
        ...
        const auto opSymbol =
            diagnostics
                .Collect(ResolveBinaryOpSymbol(
                    m_OpSrcLocation, GetScope(), lhsTypeInfo, rhsExprSema->GetTypeInfo(), m_Op
                ))
    ...
    auto CompoundAssignmentStmtSyntax::CreateStmtSema() const
